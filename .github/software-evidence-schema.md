...
- `settings`: state of `EnablePhantomVacancyFix`, `EnableOutsideConnectionVirtualSellerFix`, `EnableDemandDiagnostics`, `DiagnosticsSamplesPerDay`, `CaptureStableEvidence`, and `VerboseLogging`; older logs may also include retired legacy fields such as `EnableTradePatch`
