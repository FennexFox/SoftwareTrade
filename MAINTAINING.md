...
- treat missing producer-side trade-cost fields in the concise `input1(...)` / `input2(...)` formatter as intentional unless the change explicitly adds a separate verbose diagnostic path
