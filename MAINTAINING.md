...
- when reviewing raw-log triage output, prefer the latest bounded observation plus the newest anchored detail excerpts; the automation may also keep the immediately previous distinct sample when that helps preserve chronology
