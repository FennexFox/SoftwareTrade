...
- keep authoritative implementation in `../../../.codex/vendor/packetflow_foundry/builders/consumer-bootstrap/scripts/`
- do not place profile scaffolding logic, retained defaults, or tests under this wrapper

## Workflow

1. Run `../../../.codex/vendor/packetflow_foundry/builders/consumer-bootstrap/scripts/sync_project_profiles.py` first.
