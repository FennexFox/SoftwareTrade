...
- Do not infer an active buyer or in-flight software trade from `tradeCostEntry=True` alone; use the corresponding buyer-state fields (for example, `buyerActive`, `tripNeededCount`, `currentTradingCount`)
